...
class Charades(BaseDataset):
    ...
    def dataset_paths() -> Dict[str, Union[str, List[str], Path, Dict]]:
        ...
        for split_name in splits:
            if split_name == "miech":
                ...
                js_test_cap_idx_path = "jsfusion_val_caption_idx.pickle"
                ...
                msg = "unrecognised Charades split: {}"
        ...
        custom_paths = {
            "audio": ["aggregated_audio_feats/Audio_charades.pickle"],
        ...
        feature_info = {
            ...
            "raw_captions_path": "raw-captions.pickle",
    ...
    def sanity_checks(self):
        if self.num_test_captions == 20:
            ...
            msg = "Expected to find two missing queries in Charades for full eval"
